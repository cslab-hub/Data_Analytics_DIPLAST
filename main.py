...
add_selectbox = st.sidebar.radio(
    ...
    ("Home",'Preprocessing',"Feature Selection","Matrix Profile",'Comparison',"Classifier",'Final Data Report', 'EPA'),format_func= lambda x: 'Home' if x == 'Home' else f"{x}",help="Please select one of the options that aligns with your analytics needs."
